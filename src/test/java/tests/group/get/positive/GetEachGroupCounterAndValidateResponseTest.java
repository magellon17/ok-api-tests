 ...
 */
public class GetEachGroupCounterAndValidateResponseTest extends ApiTest {

    private static final Logger log = LoggerFactory.getLogger(GetEachGroupCounterAndValidateResponseTest.class);
